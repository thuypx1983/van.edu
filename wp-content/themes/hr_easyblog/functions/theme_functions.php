...
add_filter('body_class','hr_browser_body_class');
function hr_browser_body_class($classes) {
...
function head_addons(){
	...
	$theme_info = wp_get_theme(get_template_directory_uri() . '/style.css');	
...
function hr_custom_description() {
	global $shortname;
