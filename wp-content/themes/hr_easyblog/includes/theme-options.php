...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Enable news ticker on header",
				   "id" => $shortname."_news_ticker_enable",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "desc",),

			array( "name" => "Input comma-separated tags for the news ticker",
			...
			array( "name" => "Input comma-separated tags for the featured slider",
			...
			array( "name" => "Enable latest news",
				   "id" => $shortname."_latest_news_enable",
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "desc",),

			array( "name" => "Number of latest news to show",
				   "id" => $shortname."_latest_post_num",
				   "type" => "text",
				   "std" => "5",
				   "desc" => "desc",),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable Ad2 (728x90)",
				"id" => $shortname."_ad_728_90_enable",
				"type" => "checkbox",
				"std" => "false",
				"desc" => "desc.",),
			
			array( "name" => "Input Ads (728x90) code",
				"id" => $shortname."_ad_728_90_code",
				"type" => "textarea",
				"std" => "",
				"desc" => "desc",),
		
			array( "name" => "Enable Ads (300x250)",
				   "id" => $shortname."_ad_300_250_enable",
				   	"type" => "checkbox",
				   "std" => "false",
				   "desc" => "desc.",),
			
			array( "name" => "Input Ads (300x250) code",
				"id" => $shortname."_ad_300_250_code",
				"type" => "textarea",
				"std" => "",
				"desc" => "desc",),
		
			array( "name" => "Enable Ads (336x280)",
				"id" => $shortname."_ad_336_280_enable",
				"type" => "checkbox",
				"std" => "false",
				"desc" => "desc.",),
		
			array( "name" => "Input Ads (336x280) code",
				"id" => $shortname."_ad_336_280_code",
				"type" => "textarea",
				"std" => "",
				"desc" => "desc",),

			array( "name" => "Enable Ads (480x60)",
				   "id" => $shortname."_ad_480_60_enable",
				   	"type" => "checkbox",
				   "std" => "false",
				   "desc" => "desc.",),	
			array( "name" => "Input Ads (480x60) code",
					"id" => $shortname."_ad_480_60_code",
					"type" => "textarea",
					"std" => "",
					"desc" => "desc",),
		
			array( "name" => "Enable Ads (160x600)",
				"id" => $shortname."_ad_160_600_enable",
				"type" => "checkbox",
				"std" => "false",
				"desc" => "desc.",),
			
			array( "name" => "Input Ads (160x600) code",
				"id" => $shortname."_ad_160_600_code",
				"type" => "textarea",
				"std" => "",
				"desc" => "desc",),
